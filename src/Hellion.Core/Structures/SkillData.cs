...
namespace Hellion.Core.Structures
{
    public struct SkillData
    {
        ...
        public int tmContinuousPain;
        public int ShellQuantity;
        public int Recoil;
        public int LoadingTime;
        public int nAdjHitRate;
        ...
        public float ItemResistElecricity;
        ...
        /// <summary>
        /// Initialize a SkillData with a resource table field
        /// </summary>
        /// <param name="table"></param>
        public SkillData(ResourceTable table)
        {
            ...
            this.Cost = table.Get<int>("dwCost");
            ...
            this.HeelH = table.Get<int>("dwHeelH");
            ...
            this.tmContinuousPain = table.Get<int>("tmContinuousPain");
            ...
            this.nAdjHitRate = table.Get<int>("nAdjHitRate");
            ...
            this.RepFp = table.Get<int>("dwRepFp");
            ...
            this.SkillTime = table.Get<int>("dwSkillTime");
            ...
            this.ItemResistElecricity = table.Get<float>("fItemResistElecricity");
            ...
            this.Levels = new List<SkillLevelData>();
        }
    }
}
